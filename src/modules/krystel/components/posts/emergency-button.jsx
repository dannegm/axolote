    ...
    return (
        ...
        >
            ...
            <div className='flex-none flex-center mr-[10%] sm:mr-[20%] md:mr-[25%] lg:mr-[30%] xl:mr-[35%]'>
                <button className='cursor-pointer outline-hidden' onClick={handleClick}>
                    <div className='w-[83px] h-[83px] bg-red-50 rounded-full relative shadow-[inset_0px_0px_1px_1px_rgba(0,0,0,0.3),_2px_3px_5px_rgba(0,0,0,0.1)] flex items-center justify-center'>
                        ...
                        <label className='group cursor-pointer absolute w-[72px] h-[72px] bg-linear-to-b from-red-600 to-red-400 rounded-full left-1/2 -translate-x-1/2 top-[5px] shadow-[inset_0px_4px_2px_#fa6060,inset_0px_-4px_0px_#8a1e1e,0px_0px_2px_rgba(0,0,0,10)] active:shadow-[inset_0px_4px_2px_rgba(250,96,96,0.5),inset_0px_-4px_2px_rgba(235,37,37,0.5),0px_0px_2px_rgba(0,0,0,10)] z-20 flex items-center justify-center'>
