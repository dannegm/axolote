    ...
    return (
        <DayPicker
            ...
            components={{
                ...
                MonthGrid: ({ className, children, ...otherProps }) => (
                    <MonthGrid
                        children={children}
                        className={className}
                        displayYears={displayYears}
...
function Nav({
    ...
    const handlePreviousClick = React.useCallback(() => {
        ...
        onPrevClick && onPrevClick(previousMonth);
    ...
    const handleNextClick = React.useCallback(() => {
        ...
        goToMonth(nextMonth);
        onNextClick && onNextClick(nextMonth);
                ...
                return (
                    <Button
                        ...
                        onClick={() => {
                            setNavView('days');
                            goToMonth(
                                new Date(displayYears.from + i, selected ? selected.getMonth() : 0),
                            );
                        }}
